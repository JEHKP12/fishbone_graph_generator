...
problem_fontsize = st.number_input("Main Problem Font Size", value=9.0, min_value=1.0, step=0.5)
bone_length = st.number_input("Bone Length", value=130.0, min_value=10.0, step=5.0)
